...
describe('Q2 Tests', () => {
    ...
    it("Q22", () => {
        ...
        expect(evalP(`(L3` + q2 + q2_test_string + `(define dict (make-dict)) (dict? (result->val (put (result->val (put (result->val (put dict 3 4) ) 7 10)) 3 5)))` + `)`)).to.deep.equal(makeOk(true));
        ...
        expect(evalP(`(L3` + q2 + q2_test_string + `(define dict (make-dict)) (result->val (get (result->val (put (result->val (put (result->val (put dict 7 10) ) 3 4)) 3 5)) 3))` + `)`)).to.deep.equal(makeOk(5));
